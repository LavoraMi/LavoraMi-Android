   ...
   /*public static List<MetroStation> getStationsTram2() {
    ...
    public static List<InterchangeInfo> getInterchangesFilobus() {
        return Arrays.asList(
            ...
            new InterchangeInfo("V.Le Campania V.Le Corsica", new String[]{"12", "27", "90", "91", "93"}, "tram.fill"),
            new InterchangeInfo("Susa M4", new String[]{"M4", "38", "54", "90", "91"}, "tram.fill.tunnel"),
            new InterchangeInfo("P.Za Ferravilla", new String[]{"5", "90", "91"}, "tram.fill"),
            new InterchangeInfo("V.Le Romagna Via Pascoli", new String[]{"19", "33", "90", "91"}, "tram.fill"),
            new InterchangeInfo("V.Le Romagna Piola M2", new String[]{"M2", "39", "62", "90", "91"}, "tram.fill.tunnel"),
            new InterchangeInfo("Loreto M1 M2", new String[]{"M1", "M2", "39", "55", "56", "90", "91", "NM2"}, "tram.fill.tunnel"),
            new InterchangeInfo("Caiazzo M2", new String[]{"M2", "1", "90", "91", "92"}, "tram.fill.tunnel"),
            new InterchangeInfo("Stazione Centrale Via Tonale", new String[]{"5", "10", "42", "90", "91", "92"}, "tram.fill"),
            new InterchangeInfo("Sondrio M3", new String[]{"M3", "90", "91", "92", "NM3"}, "tram.fill.tunnel"),
            new InterchangeInfo("Zara M3 M5", new String[]{"M3", "M5", "7", "31", "51", "60", "82", "90", "91", "92", "NM3", "166"}, "tram.fill.tunnel"),
            ...
            new InterchangeInfo("Dateo FS M4", new String[]{"M4", "S1", "S2", "S5", "S6", "S12", "S13", "54", "61", "92", "NM4"}, "tram.fill.tunnel"),
            ...
            new InterchangeInfo("Corvetto M3", new String[]{"M3", "84", "93"}, "tram.fill.tunnel"),
            new InterchangeInfo("Argonne M4", new String[]{"M4", "38", "54", "93"}, "tram.fill.tunnel"),
            ...
            new InterchangeInfo("Lambrate FS M2", new String[]{"M2", "R4", "R6", "R7", "R34", "R38", "RE2", "RE6", "RE8", "RE11", "RE13", "S9", "19", "39", "45", "54", "81", "93", "175", "924", "NM2"}, "lightrail")
        );
    }
