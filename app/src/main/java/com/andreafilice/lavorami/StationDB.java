...
import com.andreafilice.lavorami.stationsDB.NETStationsDB;
...
public class StationDB {
    ...
    public static List<MetroStation> getAllStations() {
        if (CACHED_STATIONS == null) {
            ...
            allStations.addAll(NETStationsDB.getStationsZ301());
            allStations.addAll(NETStationsDB.getStationsZ304());
